# This dataset is created on the fly as a sum of the age-specific population half child variants popMprojLow and popFprojLow
...
popprojLow <- local({
	...
	tpopM <- sum.by.country(popMprojLow)
	tpopF <- sum.by.country(popFprojLow)
	...
	cbind(country_code=tpopM$country_code, 
				 name=popMprojLow[,name.col][match(tpopM$country_code, popMprojLow$country_code)],
